...
const ReservationV1 = ({ sectionClass }: DataType) => {
    ...
    return (
        <>
            <div className={`reservation-style-one-area default-padding-top ${sectionClass}`}>
                <div className="container">
                    <div className="reservation-style-one-items bg-dark text-light" data-aos="fade-up">
                        <div className="row">
