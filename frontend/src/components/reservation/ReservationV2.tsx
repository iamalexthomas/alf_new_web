                    ...
                    <div className="row">
                        <div className="col-lg-6 offset-lg-6">
                            <div className="reservation-tabs">
                                <ul className="nav nav-tabs" data-aos="fade-left" id="myTab" role="tablist">
                                ...
                                <div className="tab-content" data-aos="fade-up" id="myTabContent" data-aos-delay="300">
                                            ...
                                            <div className="row">
                                                <div className="col-lg-12">
                                                    <div className="form-group">
                                                        ...
                                                        <input className="form-control no-arrows" id="phone" name="phone" placeholder="+4733378901" type="number" required />
                                                    </div>
                                                </div>
                                            </div>
                                            <div className="row">
                                            ...
                                            <div className="row">
                                                <div className="col-lg-12">
                                                    <div className="form-group">
                                                        ...
                                                        <input className="form-control no-arrows" id="phone2" name="phone2" placeholder="+4733378901" type="number" required />
                                                    </div>
                                                </div>
                                            </div>
                                            <div className="row">
                                            ...
                                            <div className="row">
                                                <div className="col-lg-12">
                                                    <div className="form-group">
                                                        ...
                                                        <input className="form-control no-arrows" id="phone3" name="phone3" placeholder="+4733378901" type="number" required />
                                                    </div>
                                                </div>
                                            </div>
                                            <div className="row">
